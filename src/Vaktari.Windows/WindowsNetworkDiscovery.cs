...
/// DnsServiceBrowse.
///
/// INetworkDiscovery's rule is that Vaktari implements neither mDNS nor SSDP,
/// because the machine already runs a responder that has been listening since
/// boot and knows about services that appeared before Vaktari started. That
...
/// Vaktari on another machine, which announces itself over mDNS — as well as
...
/// Vaktari share, which advertises over mDNS and speaks HTTP.
/// </summary>
