...
// The same trade-off Vaktari.Windows/AssemblyInfo.cs weighs, reached the same
// way and worth restating rather than assumed from precedent.
//
// Everything else in Vaktari.Ui.Tests goes through the public surface —
...
// installer, whose other half lives in packaging/vaktari.iss. Nothing observes
// the two agreeing at runtime, and nothing fails visibly when they stop —
// setup simply loses the ability to notice a running Vaktari, months before
...
// cost.
[assembly: InternalsVisibleTo("Vaktari.Ui.Tests")]
