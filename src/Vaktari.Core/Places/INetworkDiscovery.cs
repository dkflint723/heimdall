...
///
/// Vaktari implements neither mDNS nor SSDP — the desktop already runs a responder
/// (avahi on Linux) that has been listening since boot, and it knows about
/// services that appeared before Vaktari started. Asking it is both less code and
